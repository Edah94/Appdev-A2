...
```HTML
<script src="https://unpkg.com/ol-layerswitcher@4.0.0-beta.1"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/ol-layerswitcher@4.0.0-beta.1/dist/ol-layerswitcher.css" />
```
